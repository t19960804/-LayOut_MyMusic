...
class TestController2: UITableViewController {
    ...
    let songName_1 = ["怪美的","怪美的","Shape of You","First Love","The Day We Met","查某因仔","The Day We Met","風起雲湧","有一種悲傷(電影[比悲傷更悲傷的故事])","Prelude1","Burnt Deet<累不累,腳知道>"]
    ...
    let songName_3 = ["查某因仔","有一種悲傷(電影[比悲傷更悲傷的故事])","The Specture","Love Shot","有點甜","幸福不滅","怪美的","有一種悲傷(電影[比悲傷更悲傷的故事])","I'll Never Love Again","Burnt Deet<累不累,腳知道>","有一種悲傷(電影[比悲傷更悲傷的故事])"]
